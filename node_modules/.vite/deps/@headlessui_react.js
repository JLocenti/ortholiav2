import {
  require_react_dom
} from "./chunk-QMYDNWVU.js";
import "./chunk-55LRZEGN.js";
import {
  require_react
} from "./chunk-WRDW6NEA.js";
import {
  __objRest,
  __spreadProps,
  __spreadValues,
  __toESM
} from "./chunk-NMG5HZYU.js";
...
function C({ ourProps: r9, theirProps: t18, slot: e4, defaultTag: n7, features: o13, visible: a10 = true, name: f14, mergeRefs: l13 }) {
  ...
  if (y7 & 2) {
    let _a = s17, { static: u13 = false } = _a, d16 = __objRest(_a, ["static"]);
    if (u13) return m4(d16, e4, n7, f14, l13);
  }
  if (y7 & 1) {
    let _b = s17, { unmount: u13 = true } = _b, d16 = __objRest(_b, ["unmount"]);
    return u(u13 ? 0 : 1, { [0]() {
      return null;
    }, [1]() {
      return m4(__spreadProps(__spreadValues({}, d16), { hidden: true, style: { display: "none" } }), e4, n7, f14, l13);
    } });
  }
  return m4(s17, e4, n7, f14, l13);
}
function m4(r9, t18 = {}, e4, n7, o13) {
  let _a = F3(r9, ["unmount", "static"]), { as: a10 = e4, children: f14, refName: l13 = "ref" } = _a, s17 = __objRest(_a, ["as", "children", "refName"]), y7 = r9.ref !== void 0 ? { [l13]: r9.ref } : {}, u13 = typeof f14 == "function" ? f14(t18) : f14;
...
function l4(d16, o13) {
  var n7;
  let _a = d16, { features: t18 = 1 } = _a, e4 = __objRest(_a, ["features"]), r9 = { ref: o13, "aria-hidden": (t18 & 2) === 2 ? true : (n7 = e4["aria-hidden"]) != null ? n7 : void 0, hidden: (t18 & 4) === 4 ? true : void 0, style: __spreadValues({ position: "fixed", top: 1, left: 1, width: 1, height: 0, padding: 0, margin: -1, overflow: "hidden", clip: "rect(0, 0, 0, 0)", whiteSpace: "nowrap", borderWidth: "0" }, (t18 & 4) === 4 && (t18 & 2) !== 2 && { display: "none" }) };
...
var Qe = { [1](t18) {
  var r9;
  return (r9 = t18.dataRef.current) != null && r9.disabled || t18.comboboxState === 1 ? t18 : __spreadProps(__spreadValues({}, t18), { activeOptionIndex: null, comboboxState: 1 });
}, [0](t18) {
  var r9, o13;
  ...
  if ((o13 = t18.dataRef.current) != null && o13.value) {
    ...
    if (a10 !== -1) return __spreadProps(__spreadValues({}, t18), { activeOptionIndex: a10, comboboxState: 0 });
  }
  return __spreadProps(__spreadValues({}, t18), { comboboxState: 0 });
}, [2](t18, r9) {
  ...
  if (t18.virtual) {
    ...
    return t18.activeOptionIndex === T7 && t18.activationTrigger === g5 ? t18 : __spreadProps(__spreadValues({}, t18), { activeOptionIndex: T7, activationTrigger: g5 });
  }
  let o13 = de(t18);
  ...
  return t18.activeOptionIndex === a10 && t18.activationTrigger === i8 ? t18 : __spreadProps(__spreadValues(__spreadValues({}, t18), o13), { activeOptionIndex: a10, activationTrigger: i8 });
}, [3]: (t18, r9) => {
  var u13, p7, c13;
  if ((u13 = t18.dataRef.current) != null && u13.virtual) return __spreadProps(__spreadValues({}, t18), { options: [...t18.options, r9.payload] });
  ...
  let i8 = __spreadProps(__spreadValues(__spreadValues({}, t18), a10), { activationTrigger: 2 });
  return (c13 = t18.dataRef.current) != null && c13.__demoMode && t18.dataRef.current.value === void 0 && (i8.activeOptionIndex = 0), i8;
}, [4]: (t18, r9) => {
  var a10;
  if ((a10 = t18.dataRef.current) != null && a10.virtual) return __spreadProps(__spreadValues({}, t18), { options: t18.options.filter((i8) => i8.id !== r9.id) });
  let o13 = de(t18, (i8) => {
    let u13 = i8.findIndex((p7) => p7.id === r9.id);
    return u13 !== -1 && i8.splice(u13, 1), i8;
  });
  return __spreadProps(__spreadValues(__spreadValues({}, t18), o13), { activationTrigger: 2 });
}, [5]: (t18, r9) => t18.labelId === r9.id ? t18 : __spreadProps(__spreadValues({}, t18), { labelId: r9.id }), [6]: (t18, r9) => t18.activationTrigger === r9.trigger ? t18 : __spreadProps(__spreadValues({}, t18), { activationTrigger: r9.trigger }), [7]: (t18, r9) => {
  var a10;
  ...
  return __spreadProps(__spreadValues({}, t18), { activeOptionIndex: o13, virtual: Object.assign({}, t18.virtual, { options: r9.options }) });
} };
...
function rt(t18, r9) {
  var X5, x4, O4, L2, oe5;
  let o13 = I(), _a = t18, { id: a10 = `headlessui-combobox-input-${o13}`, onChange: i8, displayValue: u13, type: p7 = "text" } = _a, c13 = __objRest(_a, ["id", "onChange", "displayValue", "type"]), e4 = j2("Combobox.Input"), l13 = ee("Combobox.Input"), T7 = y3(e4.inputRef, r9), g5 = n2(e4.inputRef), f14 = (0, import_react19.useRef)(false), v6 = p(), S10 = o2(() => {
...
function lt(t18, r9) {
  var S10;
  let o13 = j2("Combobox.Button"), a10 = ee("Combobox.Button"), i8 = y3(o13.buttonRef, r9), u13 = I(), _a = t18, { id: p7 = `headlessui-combobox-button-${u13}` } = _a, c13 = __objRest(_a, ["id"]), e4 = p(), l13 = o2((R4) => {
    switch (R4.key) {
      case o11.ArrowDown:
...
var it = "label";
function ut(t18, r9) {
  let o13 = I(), _a = t18, { id: a10 = `headlessui-combobox-label-${o13}` } = _a, i8 = __objRest(_a, ["id"]), u13 = j2("Combobox.Label"), p7 = ee("Combobox.Label"), c13 = y3(u13.labelRef, r9);
...
function dt(t18, r9) {
  let o13 = I(), _a = t18, { id: a10 = `headlessui-combobox-options-${o13}`, hold: i8 = false } = _a, u13 = __objRest(_a, ["id", "hold"]), p7 = j2("Combobox.Options"), c13 = y3(p7.optionsRef, r9), e4 = u5(), l13 = (() => e4 !== null ? (e4 & d5.Open) === d5.Open : p7.comboboxState === 0)();
  l(() => {
    var v6;
...
function ct(t18, r9) {
  var X5;
  let o13 = I(), _a = t18, { id: a10 = `headlessui-combobox-option-${o13}`, disabled: i8 = false, value: u13, order: p7 = null } = _a, c13 = __objRest(_a, ["id", "disabled", "value", "order"]), e4 = j2("Combobox.Option"), l13 = ee("Combobox.Option"), T7 = e4.virtual ? e4.activeOptionIndex === e4.calculateIndex(u13) : e4.activeOptionIndex === null ? false : ((X5 = e4.options[e4.activeOptionIndex]) == null ? void 0 : X5.id) === a10, g5 = e4.isSelected(u13), f14 = (0, import_react19.useRef)(null), v6 = s2({ disabled: i8, value: u13, domRef: f14, order: p7 }), S10 = (0, import_react19.useContext)(Ce), R4 = y3(r9, f14, S10 ? S10.measureElement : null), s17 = o2(() => l13.onChange(u13));
...
function z(t18, n7) {
  let e4 = (0, import_react24.useRef)(null), o13 = y3(e4, n7), _a = t18, { initialFocus: l13, containers: c13, features: r9 = 30 } = _a, s17 = __objRest(_a, ["initialFocus", "containers", "features"]);
  l2() || (r9 = 1);
  let i8 = n2(e4);
...
function j3(p7, n7) {
  let _a = p7, { target: l13 } = _a, e4 = __objRest(_a, ["target"]), o13 = { ref: y3(n7) };
...
var I5 = "p";
function S6(r9, t18) {
  let a10 = I(), _a = r9, { id: e4 = `headlessui-description-${a10}` } = _a, i8 = __objRest(_a, ["id"]), n7 = f10(), s17 = y3(t18);
  l(() => n7.register(e4), [e4, n7.register]);
  let o13 = __spreadProps(__spreadValues({ ref: s17 }, n7.props), { id: e4 });
...
var He = { [0](o13, e4) {
  return o13.titleId === e4.id ? o13 : __spreadProps(__spreadValues({}, o13), { titleId: e4.id });
} };
...
function We(o13, e4) {
  let r9 = I(), _a = o13, { id: i8 = `headlessui-dialog-${r9}`, open: n7, onClose: l13, initialFocus: s17, role: a10 = "dialog", __demoMode: T7 = false } = _a, m12 = __objRest(_a, ["id", "open", "onClose", "initialFocus", "role", "__demoMode"]), [M7, f14] = (0, import_react30.useState)(0), U7 = (0, import_react30.useRef)(false);
  a10 = function() {
...
var $e2 = "div";
function Ye2(o13, e4) {
  let r9 = I(), _a = o13, { id: i8 = `headlessui-dialog-overlay-${r9}` } = _a, n7 = __objRest(_a, ["id"]), [{ dialogState: l13, close: s17 }] = b3("Dialog.Overlay"), a10 = y3(e4), T7 = o2((f14) => {
...
var je = "div";
function Je(o13, e4) {
  let r9 = I(), _a = o13, { id: i8 = `headlessui-dialog-backdrop-${r9}` } = _a, n7 = __objRest(_a, ["id"]), [{ dialogState: l13 }, s17] = b3("Dialog.Backdrop"), a10 = y3(e4);
...
var Xe = "div";
function Ke(o13, e4) {
  let r9 = I(), _a = o13, { id: i8 = `headlessui-dialog-panel-${r9}` } = _a, n7 = __objRest(_a, ["id"]), [{ dialogState: l13 }, s17] = b3("Dialog.Panel"), a10 = y3(e4, s17.panelRef), T7 = (0, import_react30.useMemo)(() => ({ open: l13 === 0 }), [l13]), m12 = o2((f14) => {
    f14.stopPropagation();
  });
...
var Ve2 = "h2";
function qe2(o13, e4) {
  let r9 = I(), _a = o13, { id: i8 = `headlessui-dialog-title-${r9}` } = _a, n7 = __objRest(_a, ["id"]), [{ dialogState: l13, setTitleId: s17 }] = b3("Dialog.Title"), a10 = y3(e4);
...
var Y2 = { [0]: (e4) => __spreadProps(__spreadValues({}, e4), { disclosureState: u(e4.disclosureState, { [0]: 1, [1]: 0 }) }), [1]: (e4) => e4.disclosureState === 1 ? e4 : __spreadProps(__spreadValues({}, e4), { disclosureState: 1 }), [4](e4) {
  ...
  return e4.buttonId === n7.buttonId ? e4 : __spreadProps(__spreadValues({}, e4), { buttonId: n7.buttonId });
}, [3](e4, n7) {
  return e4.panelId === n7.panelId ? e4 : __spreadProps(__spreadValues({}, e4), { panelId: n7.panelId });
} };
...
function ne(e4, n7) {
  let _a = e4, { defaultOpen: o13 = false } = _a, i8 = __objRest(_a, ["defaultOpen"]), f14 = (0, import_react32.useRef)(null), l13 = y3(n7, T4((u13) => {
    f14.current = u13;
...
var le = "button";
function oe(e4, n7) {
  let o13 = I(), _a = e4, { id: i8 = `headlessui-disclosure-button-${o13}` } = _a, f14 = __objRest(_a, ["id"]), [l13, t18] = _4("Disclosure.Button"), d16 = Z2(), s17 = d16 === null ? false : d16 === l13.panelId, c13 = (0, import_react32.useRef)(null), a10 = y3(c13, n7, s17 ? null : l13.buttonRef), D7 = I3();
...
function ue2(e4, n7) {
  let o13 = I(), _a = e4, { id: i8 = `headlessui-disclosure-panel-${o13}` } = _a, f14 = __objRest(_a, ["id"]), [l13, t18] = _4("Disclosure.Panel"), { close: d16 } = K2("Disclosure.Panel"), s17 = I3(), c13 = y3(n7, l13.panelRef, (T7) => {
    a7(() => t18({ type: T7 ? 4 : 5 }));
  });
...
var je2 = { [1](e4) {
  return e4.dataRef.current.disabled || e4.listboxState === 1 ? e4 : __spreadProps(__spreadValues({}, e4), { activeOptionIndex: null, listboxState: 1 });
}, [0](e4) {
  ...
  return r9 !== -1 && (a10 = r9), __spreadProps(__spreadValues({}, e4), { listboxState: 0, activeOptionIndex: a10 });
}, [2](e4, a10) {
  var l13;
  ...
  return __spreadProps(__spreadValues(__spreadValues({}, e4), n7), { searchQuery: "", activeOptionIndex: r9, activationTrigger: (l13 = a10.trigger) != null ? l13 : 1 });
}, [3]: (e4, a10) => {
  if (e4.dataRef.current.disabled || e4.listboxState === 1) return e4;
  ...
  return u13 === -1 || u13 === e4.activeOptionIndex ? __spreadProps(__spreadValues({}, e4), { searchQuery: l13 }) : __spreadProps(__spreadValues({}, e4), { searchQuery: l13, activeOptionIndex: u13, activationTrigger: 1 });
}, [4](e4) {
  return e4.dataRef.current.disabled || e4.listboxState === 1 || e4.searchQuery === "" ? e4 : __spreadProps(__spreadValues({}, e4), { searchQuery: "" });
}, [5]: (e4, a10) => {
  let n7 = { id: a10.id, dataRef: a10.dataRef }, r9 = z2(e4, (l13) => [...l13, n7]);
  return e4.activeOptionIndex === null && e4.dataRef.current.isSelected(a10.dataRef.current.value) && (r9.activeOptionIndex = r9.options.indexOf(n7)), __spreadValues(__spreadValues({}, e4), r9);
}, [6]: (e4, a10) => {
  let n7 = z2(e4, (r9) => {
    let l13 = r9.findIndex((t18) => t18.id === a10.id);
    return l13 !== -1 && r9.splice(l13, 1), r9;
  });
  return __spreadProps(__spreadValues(__spreadValues({}, e4), n7), { activationTrigger: 1 });
}, [7]: (e4, a10) => __spreadProps(__spreadValues({}, e4), { labelId: a10.id }) };
...
function Qe3(e4, a10) {
  let _a = e4, { value: n7, defaultValue: r9, form: l13, name: t18, onChange: p7, by: u13 = (s17, c13) => s17 === c13, disabled: i8 = false, horizontal: b7 = false, multiple: R4 = false } = _a, m12 = __objRest(_a, ["value", "defaultValue", "form", "name", "onChange", "by", "disabled", "horizontal", "multiple"]);
  ...
  } : u13), A3 = (0, import_react34.useCallback)((s17) => u(d16.mode, { [1]: () => g5.some((c13) => I11(c13, s17)), [0]: () => I11(g5, s17) }), [g5]), d16 = (0, import_react34.useMemo)(() => __spreadProps(__spreadValues({}, T7), { value: g5, disabled: i8, mode: R4 ? 1 : 0, orientation: P5, compare: I11, isSelected: A3, optionsPropsRef: L2, labelRef: U7, buttonRef: B4, optionsRef: W }), [g5, i8, R4, T7]);
  l(() => {
  ...
  }, [G4, x4]), import_react34.default.createElement(J.Provider, { value: fe4 }, import_react34.default.createElement(q2.Provider, { value: d16 }, import_react34.default.createElement(s9, { value: u(d16.listboxState, { [0]: d5.Open, [1]: d5.Closed }) }, t18 != null && g5 != null && e({ [t18]: g5 }).map(([s17, c13], O4) => import_react34.default.createElement(u4, __spreadValues({ features: s8.Hidden, ref: O4 === 0 ? (C7) => {
    var Y3;
...
function Xe2(e4, a10) {
  var x4;
  let n7 = I(), _a = e4, { id: r9 = `headlessui-listbox-button-${n7}` } = _a, l13 = __objRest(_a, ["id"]), t18 = w4("Listbox.Button"), p7 = k2("Listbox.Button"), u13 = y3(t18.buttonRef, a10), i8 = p(), b7 = o2((T7) => {
    switch (T7.key) {
      case o11.Space:
      case o11.Enter:
      case o11.ArrowDown:
...
var $e3 = "label";
function ze3(e4, a10) {
  let n7 = I(), _a = e4, { id: r9 = `headlessui-listbox-label-${n7}` } = _a, l13 = __objRest(_a, ["id"]), t18 = w4("Listbox.Label"), p7 = k2("Listbox.Label"), u13 = y3(t18.labelRef, a10);
...
function Ye3(e4, a10) {
  var T7;
  let n7 = I(), _a = e4, { id: r9 = `headlessui-listbox-options-${n7}` } = _a, l13 = __objRest(_a, ["id"]), t18 = w4("Listbox.Options"), p7 = k2("Listbox.Options"), u13 = y3(t18.optionsRef, a10), i8 = p(), b7 = p(), R4 = u5(), m12 = (() => R4 !== null ? (R4 & d5.Open) === d5.Open : t18.listboxState === 0)();
...
var Te = { [1](e4) {
  return e4.menuState === 1 ? e4 : __spreadProps(__spreadValues({}, e4), { activeItemIndex: null, menuState: 1 });
}, [0](e4) {
  return e4.menuState === 0 ? e4 : __spreadProps(__spreadValues({}, e4), { __demoMode: false, menuState: 0 });
}, [2]: (e4, u13) => {
  var i8;
  ...
  return __spreadProps(__spreadValues(__spreadValues({}, e4), r9), { searchQuery: "", activeItemIndex: s17, activationTrigger: (i8 = u13.trigger) != null ? i8 : 1 });
}, [3]: (e4, u13) => {
  ...
  return a10 === -1 || a10 === e4.activeItemIndex ? __spreadProps(__spreadValues({}, e4), { searchQuery: i8 }) : __spreadProps(__spreadValues({}, e4), { searchQuery: i8, activeItemIndex: a10, activationTrigger: 1 });
}, [4](e4) {
  return e4.searchQuery === "" ? e4 : __spreadProps(__spreadValues({}, e4), { searchQuery: "", searchActiveItemIndex: null });
}, [5]: (e4, u13) => {
  let r9 = w5(e4, (s17) => [...s17, { id: u13.id, dataRef: u13.dataRef }]);
  return __spreadValues(__spreadValues({}, e4), r9);
}, [6]: (e4, u13) => {
  let r9 = w5(e4, (s17) => {
    let i8 = s17.findIndex((t18) => t18.id === u13.id);
    return i8 !== -1 && s17.splice(i8, 1), s17;
  });
  return __spreadProps(__spreadValues(__spreadValues({}, e4), r9), { activationTrigger: 1 });
} };
...
function Me2(e4, u13) {
  let _a = e4, { __demoMode: r9 = false } = _a, s17 = __objRest(_a, ["__demoMode"]), i8 = (0, import_react35.useReducer)(ye3, { __demoMode: r9, menuState: r9 ? 0 : 1, buttonRef: (0, import_react35.createRef)(), itemsRef: (0, import_react35.createRef)(), items: [], searchQuery: "", activeItemIndex: null, activationTrigger: 1 }), [{ menuState: t18, itemsRef: o13, buttonRef: a10 }, l13] = i8, m12 = y3(u13);
  y2([a10, o13], (g5, R4) => {
    var p7;
...
function Re(e4, u13) {
  var R4;
  let r9 = I(), _a = e4, { id: s17 = `headlessui-menu-button-${r9}` } = _a, i8 = __objRest(_a, ["id"]), [t18, o13] = C3("Menu.Button"), a10 = y3(t18.buttonRef, u13), l13 = p(), m12 = o2((p7) => {
    switch (p7.key) {
      case o11.Space:
      case o11.Enter:
      case o11.ArrowDown:
...
function Ee2(e4, u13) {
  var M7, b7;
  let r9 = I(), _a = e4, { id: s17 = `headlessui-menu-items-${r9}` } = _a, i8 = __objRest(_a, ["id"]), [t18, o13] = C3("Menu.Items"), a10 = y3(t18.itemsRef, u13), l13 = n2(t18.itemsRef), m12 = p(), I11 = u5(), A3 = (() => I11 !== null ? (I11 & d5.Open) === d5.Open : t18.menuState === 0)();
...
function xe2(e4, u13) {
  let r9 = I(), _a = e4, { id: s17 = `headlessui-menu-item-${r9}`, disabled: i8 = false } = _a, t18 = __objRest(_a, ["id", "disabled"]), [o13, a10] = C3("Menu.Item"), l13 = o13.activeItemIndex !== null ? o13.items[o13.activeItemIndex].id === s17 : false, m12 = (0, import_react35.useRef)(null), I11 = y3(u13, m12);
  l(() => {
...
var Ge3 = { [0]: (t18) => {
  let o13 = __spreadProps(__spreadValues({}, t18), { popoverState: u(t18.popoverState, { [0]: 1, [1]: 0 }) });
  return o13.popoverState === 0 && (o13.__demoMode = false), o13;
}, [1](t18) {
  return t18.popoverState === 1 ? t18 : __spreadProps(__spreadValues({}, t18), { popoverState: 1 });
}, [2](t18, o13) {
  return t18.button === o13.button ? t18 : __spreadProps(__spreadValues({}, t18), { button: o13.button });
}, [3](t18, o13) {
  return t18.buttonId === o13.buttonId ? t18 : __spreadProps(__spreadValues({}, t18), { buttonId: o13.buttonId });
}, [4](t18, o13) {
  return t18.panel === o13.panel ? t18 : __spreadProps(__spreadValues({}, t18), { panel: o13.panel });
}, [5](t18, o13) {
  return t18.panelId === o13.panelId ? t18 : __spreadProps(__spreadValues({}, t18), { panelId: o13.panelId });
} };
...
function Ue2(t18, o13) {
  var B4;
  let _a = t18, { __demoMode: u13 = false } = _a, M7 = __objRest(_a, ["__demoMode"]), x4 = (0, import_react36.useRef)(null), n7 = y3(o13, T4((l13) => {
    x4.current = l13;
...
function Ke3(t18, o13) {
  let u13 = I(), _a = t18, { id: M7 = `headlessui-popover-button-${u13}` } = _a, x4 = __objRest(_a, ["id"]), [n7, e4] = oe2("Popover.Button"), { isPortalled: c13 } = fe2("Popover.Button"), f14 = (0, import_react36.useRef)(null), s17 = `headlessui-focus-sentinel-${I()}`, I11 = Ee3(), a10 = I11 == null ? void 0 : I11.closeOthers, y7 = Ne3() !== null;
...
function $e4(t18, o13) {
  let u13 = I(), _a = t18, { id: M7 = `headlessui-popover-overlay-${u13}` } = _a, x4 = __objRest(_a, ["id"]), [{ popoverState: n7 }, e4] = oe2("Popover.Overlay"), c13 = y3(o13), f14 = u5(), s17 = (() => f14 !== null ? (f14 & d5.Open) === d5.Open : n7 === 0)(), I11 = o2((y7) => {
...
function Ye4(t18, o13) {
  let u13 = I(), _a = t18, { id: M7 = `headlessui-popover-panel-${u13}`, focus: x4 = false } = _a, n7 = __objRest(_a, ["id", "focus"]), [e4, c13] = oe2("Popover.Panel"), { close: f14, isPortalled: s17 } = fe2("Popover.Panel"), I11 = `headlessui-focus-sentinel-before-${I()}`, a10 = `headlessui-focus-sentinel-after-${I()}`, v6 = (0, import_react36.useRef)(null), y7 = y3(v6, o13, (i8) => {
    c13({ type: 4, panel: i8 });
  }), A3 = n2(v6), P5 = I3();
...
var A = "label";
function h8(a10, t18) {
  let i8 = I(), _a = a10, { id: e4 = `headlessui-label-${i8}`, passive: s17 = false } = _a, o13 = __objRest(_a, ["id", "passive"]), r9 = u12(), l13 = y3(t18);
  l(() => r9.register(e4), [e4, r9.register]);
  let n7 = __spreadProps(__spreadValues({ ref: l13 }, r9.props), { id: e4 });
...
var Ce2 = { [0](o13, r9) {
  ...
  return __spreadProps(__spreadValues({}, o13), { options: I2(t18, (p7) => p7.element.current) });
}, [1](o13, r9) {
  let t18 = o13.options.slice(), p7 = o13.options.findIndex((T7) => T7.id === r9.id);
  return p7 === -1 ? o13 : (t18.splice(p7, 1), __spreadProps(__spreadValues({}, o13), { options: t18 }));
} };
...
var Le2 = "div";
function he3(o13, r9) {
  let t18 = I(), _a = o13, { id: p7 = `headlessui-radiogroup-${t18}`, value: T7, defaultValue: v6, form: M7, name: m12, onChange: H6, by: G4 = (e4, i8) => e4 === i8, disabled: P5 = false } = _a, N7 = __objRest(_a, ["id", "value", "defaultValue", "form", "name", "onChange", "by", "disabled"]), y7 = o2(typeof G4 == "string" ? (e4, i8) => {
    let n7 = G4;
  ...
  }), c13 = o2((e4) => (L2(__spreadValues({ type: 0 }, e4)), () => L2({ type: 1, id: e4.id }))), w6 = (0, import_react39.useMemo)(() => __spreadValues({ value: l13, firstOption: b7, containsCheckedOption: x4, disabled: P5, compare: y7 }, A3), [l13, b7, x4, P5, y7, A3]), ie5 = (0, import_react39.useMemo)(() => ({ registerOption: c13, change: d16 }), [c13, d16]), ae3 = { ref: W, id: p7, role: "radiogroup", "aria-labelledby": h9, "aria-describedby": C7, onKeyDown: F10 }, pe2 = (0, import_react39.useMemo)(() => ({ value: l13 }), [l13]), I11 = (0, import_react39.useRef)(null), le3 = p();
  return (0, import_react39.useEffect)(() => {
    I11.current && v6 !== void 0 && le3.addEventListener(I11.current, "reset", () => {
      d16(v6);
    });
  }, [I11, d16]), import_react39.default.createElement(U7, { name: "RadioGroup.Description" }, import_react39.default.createElement(R4, { name: "RadioGroup.Label" }, import_react39.default.createElement($3.Provider, { value: ie5 }, import_react39.default.createElement(B3.Provider, { value: w6 }, m12 != null && l13 != null && e({ [m12]: l13 }).map(([e4, i8], n7) => import_react39.default.createElement(u4, __spreadValues({ features: s8.Hidden, ref: n7 === 0 ? (f14) => {
    var u13;
...
function we3(o13, r9) {
  var F10;
  let t18 = I(), _a = o13, { id: p7 = `headlessui-radiogroup-option-${t18}`, value: T7, disabled: v6 = false } = _a, M7 = __objRest(_a, ["id", "value", "disabled"]), m12 = (0, import_react39.useRef)(null), H6 = y3(m12, r9), [G4, P5] = F6(), [N7, y7] = w3(), { addFlag: A3, removeFlag: L2, hasFlag: a10 } = c10(1), h9 = s2({ value: T7, disabled: v6 }), R4 = oe3("RadioGroup.Option"), C7 = ne2("RadioGroup.Option");
...
function re3(r9, n7) {
  var E8;
  let p7 = I(), _a = r9, { id: c13 = `headlessui-switch-${p7}`, checked: T7, defaultChecked: o13 = false, onChange: b7, disabled: a10 = false, name: d16, value: y7, form: u13 } = _a, m12 = __objRest(_a, ["id", "checked", "defaultChecked", "onChange", "disabled", "name", "value", "form"]), t18 = (0, import_react40.useContext)(S8), f14 = (0, import_react40.useRef)(null), C7 = y3(f14, n7, t18 === null ? null : t18.setSwitch), [i8, s17] = T(T7, b7, o13), w6 = o2(() => s17 == null ? void 0 : s17(!i8)), L2 = o2((e4) => {
...
var ce3 = { [0](e4, n7) {
  ...
  }), a10 = __spreadProps(__spreadValues({}, e4), { tabs: t18, panels: l13 });
  if (n7.index < 0 || n7.index > t18.length - 1) {
    ...
    return __spreadProps(__spreadValues({}, a10), { selectedIndex: p7 === -1 ? e4.selectedIndex : p7 });
  }
  ...
  return b7 === -1 && (b7 = e4.selectedIndex), __spreadProps(__spreadValues({}, a10), { selectedIndex: b7 });
}, [1](e4, n7) {
  ...
  return e4.info.current.isControlled || (o13 = l13.indexOf(t18), o13 === -1 && (o13 = e4.selectedIndex)), __spreadProps(__spreadValues({}, e4), { tabs: l13, selectedIndex: o13 });
}, [2](e4, n7) {
  return __spreadProps(__spreadValues({}, e4), { tabs: e4.tabs.filter((t18) => t18 !== n7.tab) });
}, [3](e4, n7) {
  return e4.panels.includes(n7.panel) ? e4 : __spreadProps(__spreadValues({}, e4), { panels: I2([...e4.panels, n7.panel], (t18) => t18.current) });
}, [4](e4, n7) {
  return __spreadProps(__spreadValues({}, e4), { panels: e4.panels.filter((t18) => t18 !== n7.panel) });
} };
...
function me3(e4, n7) {
  let _a = e4, { defaultIndex: t18 = 0, vertical: l13 = false, manual: o13 = false, onChange: a10, selectedIndex: T7 = null } = _a, R4 = __objRest(_a, ["defaultIndex", "vertical", "manual", "onChange", "selectedIndex"]);
  ...
  })), E8 = s2(u13.tabs), L2 = (0, import_react42.useMemo)(() => __spreadValues({ orientation: m12, activation: b7 }, u13), [m12, b7, u13]), A3 = o2((s17) => (f14({ type: 1, tab: s17 }), () => f14({ type: 2, tab: s17 }))), S10 = o2((s17) => (f14({ type: 3, panel: s17 }), () => f14({ type: 4, panel: s17 }))), k3 = o2((s17) => {
...
function ge4(e4, n7) {
  var O4, s17;
  let t18 = I(), _a = e4, { id: l13 = `headlessui-tabs-tab-${t18}` } = _a, o13 = __objRest(_a, ["id"]), { orientation: a10, activation: T7, selectedIndex: R4, tabs: m12, panels: b7 } = F8("Tab"), i8 = q4("Tab"), c13 = F8("Tab"), p7 = (0, import_react42.useRef)(null), u13 = y3(p7, n7);
...
function _e3(e4, n7) {
  var E8, L2, A3, S10;
  let t18 = I(), _a = e4, { id: l13 = `headlessui-tabs-panel-${t18}`, tabIndex: o13 = 0 } = _a, a10 = __objRest(_a, ["id", "tabIndex"]), { selectedIndex: T7, tabs: R4, panels: m12 } = F8("Tab.Panel"), b7 = q4("Tab.Panel"), i8 = (0, import_react42.useRef)(null), c13 = y3(i8, n7);
  ...
  return !f14 && ((A3 = a10.unmount) == null || A3) && !((S10 = a10.static) != null && S10) ? import_react42.default.createElement(u4, __spreadValues({ as: "span", "aria-hidden": "true" }, g5)) : C({ ourProps: g5, theirProps: a10, slot: P5, defaultTag: Re2, features: Le3, visible: f14, name: "Tabs.Panel" });
}
var Se3 = U(ge4);
var Ie4 = U(me3);
var De2 = U(ye4);
...
function He4(t18, n7) {
  var Q5, Y3;
  let _a = t18, { beforeEnter: r9, afterEnter: s17, beforeLeave: R4, afterLeave: D7, enter: p7, enterFrom: x4, enterTo: h9, entered: v6, leave: u13, leaveFrom: g5, leaveTo: d16 } = _a, i8 = __objRest(_a, ["beforeEnter", "afterEnter", "beforeLeave", "afterLeave", "enter", "enterFrom", "enterTo", "entered", "leave", "leaveFrom", "leaveTo"]), e4 = (0, import_react43.useRef)(null), a10 = y3(e4, n7), o13 = (Q5 = i8.unmount) == null || Q5 ? v.Unmount : v.Hidden, { show: f14, appear: N7, initial: T7 } = ye5(), [l13, j5] = (0, import_react43.useState)(f14 ? "visible" : "hidden"), z4 = xe5(), { register: L2, unregister: O4 } = z4;
  ...
  return K4 ? P5 = __spreadProps(__spreadValues({}, P5), { className: t9(i8.className, ...k3.current.enter, ...k3.current.enterFrom) }) : B4.current && (P5.className = t9(i8.className, (Y3 = e4.current) == null ? void 0 : Y3.className), P5.className === "" && delete P5.className), import_react43.default.createElement(M6.Provider, { value: w6 }, import_react43.default.createElement(s9, { value: u(l13, { ["visible"]: d5.Open, ["hidden"]: d5.Closed }) | H6.flags }, C({ ourProps: ce4, theirProps: P5, defaultTag: De3, features: le2, visible: l13 === "visible", name: "Transition.Child" })));
}
function Fe4(t18, n7) {
  let _a = t18, { show: r9, appear: s17 = false, unmount: R4 = true } = _a, D7 = __objRest(_a, ["show", "appear", "unmount"]), p7 = (0, import_react43.useRef)(null), x4 = y3(p7, n7);
  l2();
  let h9 = u5();
  ...
  return import_react43.default.createElement(M6.Provider, { value: g5 }, import_react43.default.createElement(I10.Provider, { value: a10 }, C({ ourProps: __spreadProps(__spreadValues({}, o13), { as: import_react43.Fragment, children: import_react43.default.createElement(ue6, __spreadProps(__spreadValues(__spreadValues({ ref: x4 }, o13), D7), { beforeEnter: f14, beforeLeave: N7 })) }), theirProps: {}, defaultTag: import_react43.Fragment, features: le2, visible: v6 === "visible", name: "Transition" })));
}
function _e4(t18, n7) {
  let r9 = (0, import_react43.useContext)(I10) !== null, s17 = u5() !== null;
  return import_react43.default.createElement(import_react43.default.Fragment, null, !r9 && s17 ? import_react43.default.createElement(q5, __spreadValues({ ref: n7 }, t18)) : import_react43.default.createElement(ue6, __spreadValues({ ref: n7 }, t18)));
}
var q5 = U(Fe4);
var ue6 = U(He4);
var Le4 = U(_e4);
