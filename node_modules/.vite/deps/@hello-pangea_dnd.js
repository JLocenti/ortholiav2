    ...
    if (forwardRef2) {
      const _forwarded = React.forwardRef(
        function forwardConnectRef(props, ref2) {
          return React.createElement(Connect, __spreadProps(__spreadValues({}, props), { reactReduxForwardedRef: ref2 }));
        }
      );
...
var withMaxScroll = (frame, max) => __spreadProps(__spreadValues({}, frame), {
...
var createAutoScrollerOptions = (props) => __spreadProps(__spreadValues(__spreadValues({}, defaultAutoScrollerOptions), props.autoScrollerOptions), {
...
function App(props) {
  ...
  const autoScroller = useMemo2(() => createAutoScroller(__spreadValues({
    scrollWindow,
