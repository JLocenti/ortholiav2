  ...
  toReadableStream() {
    ...
    return new ReadableStream2({
      ...
      cancel() {
        return __async(this, null, function* () {
          var _a3;
          yield (_a3 = iter.return) == null ? void 0 : _a3.call(iter);
        });
      }
    });
  }
...
var APIClient = class {
  ...
  methodRequest(method, path, opts) {
    return this.request(Promise.resolve(opts).then((opts2) => __async(this, null, function* () {
      const body = opts2 && isBlobLike(opts2 == null ? void 0 : opts2.body) ? new DataView(yield opts2.body.arrayBuffer()) : (opts2 == null ? void 0 : opts2.body) instanceof DataView ? opts2.body : (opts2 == null ? void 0 : opts2.body) instanceof ArrayBuffer ? new DataView(opts2.body) : opts2 && ArrayBuffer.isView(opts2 == null ? void 0 : opts2.body) ? new DataView(opts2.body.buffer) : opts2 == null ? void 0 : opts2.body;
  ...
  fetchWithTimeout(url, init, ms, controller) {
    return __async(this, null, function* () {
      ...
      return (
        ...
        this.fetch.call(void 0, url, __spreadValues({ signal: controller.signal }, options)).finally(() => {
...
var FileBatches = class extends APIResource {
  ...
  poll(vectorStoreId, batchId, options) {
    return __async(this, null, function* () {
      ...
      while (true) {
        const { data: batch, response } = yield this.retrieve(vectorStoreId, batchId, __spreadProps(__spreadValues({}, options), {
          headers
        })).withResponse();
        switch (batch.status) {
          case "in_progress":
